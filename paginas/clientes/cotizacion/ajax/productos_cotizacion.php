<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('cod_articulo', 'nombre');//Columnas de busqueda
		 $sTable = "articulos";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<input type="number" class="form-control" min="1" minlength="1" style="text-align:left" id="cantidad_<?php echo $id_producto; ?>"  value="1" >
						</div></td>
						<td class='col-xs-2'><div class="pull-right">
						<input type="text" class="form-control" style="text-align:right" id="precio_venta_<?php echo $id_producto; ?>"  value="<?php echo $precio_venta;?>" readonly="readonly">
						</div></td>
